       ...
       <div class="col-10">
           <div class="row" style="height: 75vh!important;">
                ...
                <div class="col-12 row no-gutters">
                    ...
                    <div id="sprite-slot-89" class="col sprite-slot"></div>
                    <div id="sprite-slot-90" class="col sprite-slot"></div>
                </div>
                <div class="col-12 row no-gutters">
                    <div id="sprite-slot-91" class="col sprite-slot"></div>
                    <div id="sprite-slot-92" class="col sprite-slot"></div>
                    <div id="sprite-slot-93" class="col sprite-slot"></div>
                    <div id="sprite-slot-94" class="col sprite-slot"></div>
                    <div id="sprite-slot-95" class="col sprite-slot"></div>
                    <div id="sprite-slot-96" class="col sprite-slot"></div>
                    <div id="sprite-slot-97" class="col sprite-slot"></div>
                    <div id="sprite-slot-98" class="col sprite-slot"></div>
                    <div id="sprite-slot-99" class="col sprite-slot"></div>
                    <div id="sprite-slot-100" class="col sprite-slot"></div>
                    <div id="sprite-slot-101" class="col sprite-slot"></div>
                    <div id="sprite-slot-102" class="col sprite-slot"></div>
                    <div id="sprite-slot-103" class="col sprite-slot"></div>
                    <div id="sprite-slot-104" class="col sprite-slot"></div>
                    <div id="sprite-slot-105" class="col sprite-slot"></div>
                    <div id="sprite-slot-106" class="col sprite-slot"></div>
                    <div id="sprite-slot-107" class="col sprite-slot"></div>
                    <div id="sprite-slot-108" class="col sprite-slot"></div>
                </div>
                <div class="col-12 row no-gutters">
                    <div id="sprite-slot-109" class="col sprite-slot"></div>
                    <div id="sprite-slot-110" class="col sprite-slot"></div>
                    <div id="sprite-slot-111" class="col sprite-slot"></div>
                    <div id="sprite-slot-112" class="col sprite-slot"></div>
                    <div id="sprite-slot-113" class="col sprite-slot"></div>
                    <div id="sprite-slot-114" class="col sprite-slot"></div>
                    <div id="sprite-slot-115" class="col sprite-slot"></div>
                    <div id="sprite-slot-116" class="col sprite-slot"></div>
                    <div id="sprite-slot-117" class="col sprite-slot"></div>
                    <div id="sprite-slot-118" class="col sprite-slot"></div>
                    <div id="sprite-slot-119" class="col sprite-slot"></div>
                    <div id="sprite-slot-120" class="col sprite-slot"></div>
                    <div id="sprite-slot-121" class="col sprite-slot"></div>
                    <div id="sprite-slot-122" class="col sprite-slot"></div>
                    <div id="sprite-slot-123" class="col sprite-slot"></div>
                    <div id="sprite-slot-124" class="col sprite-slot"></div>
                    <div id="sprite-slot-125" class="col sprite-slot"></div>
                    <div id="sprite-slot-126" class="col sprite-slot"></div>
                </div>
                <div class="col-12 row no-gutters">
                    <div id="sprite-slot-127" class="col sprite-slot"></div>
                    <div id="sprite-slot-128" class="col sprite-slot"></div>
                    <div id="sprite-slot-129" class="col sprite-slot"></div>
                    <div id="sprite-slot-130" class="col sprite-slot"></div>
                    <div id="sprite-slot-131" class="col sprite-slot"></div>
                    <div id="sprite-slot-132" class="col sprite-slot"></div>
                    <div id="sprite-slot-133" class="col sprite-slot"></div>
                    <div id="sprite-slot-134" class="col sprite-slot"></div>
                    <div id="sprite-slot-135" class="col sprite-slot"></div>
                    <div id="sprite-slot-136" class="col sprite-slot"></div>
                    <div id="sprite-slot-137" class="col sprite-slot"></div>
                    <div id="sprite-slot-138" class="col sprite-slot"></div>
                    <div id="sprite-slot-139" class="col sprite-slot"></div>
                    <div id="sprite-slot-140" class="col sprite-slot"></div>
                    <div id="sprite-slot-141" class="col sprite-slot"></div>
                    <div id="sprite-slot-142" class="col sprite-slot"></div>
                    <div id="sprite-slot-143" class="col sprite-slot"></div>
                    <div id="sprite-slot-144" class="col sprite-slot"></div>
                </div>
           </div>
